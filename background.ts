import { MonitorTask, Announcement, OffscreenMessage, ParseResult } from './types';
...
async function checkAllTasks() {
  ...
  try {
    ...
    const tasks: MonitorTask[] = data.tasks || [];
  ...
  // Note: In a production extension, we might keep the offscreen doc open or close it to save resources.
  // await closeOffscreenDocument();
}

// Helper: Send message to offscreen
async function sendMessageToOffscreen(message: OffscreenMessage): Promise<ParseResult> {
